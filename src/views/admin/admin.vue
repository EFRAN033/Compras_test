<template>
  ...
  const handleAdminLogin = async () => {
    ...
    // *** CAMBIO CLAVE AQUÍ: Definir la URL base de la API según el entorno ***
    // VITE_APP_API_BASE_URL debe configurarse en tu archivo .env.local o .env.production
    ...
    try {
      ...
      setTimeout(() => {
        router.push('/admin_pro'); // Redirige al panel de administración (admin_pro.vue)
      }, 1000);
