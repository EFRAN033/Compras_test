      ...
      <div class="flex flex-col items-center lg:flex-row-reverse lg:gap-16">
        ...
        <div class="lg:w-1/2 lg:pr-10 text-center lg:text-left opacity-0 animate-[slideInLeftGentle_0.8s_ease-out_forwards_0s]">
          ...
          <client-logo-carousel
            class="opacity-0 animate-[fadeInUpSoft_0.8s_ease-out_forwards_1.2s]"
          />
        </div>
      </div>
    </div>
...
<script>
import ClientLogoCarousel from './ClientLogoCarousel.vue'; // Esta ruta es para la misma carpeta

export default {
  name: "HeroSection",
  components: {
    ClientLogoCarousel, // Register the new component
  },
  data() {
    return {
