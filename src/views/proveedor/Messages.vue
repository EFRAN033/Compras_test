      ...
      <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
          ...
          <button
            ...
            @click="markAllAsRead"
            class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
          >
        ...
        <div class="p-0">
          <div v-if="messages.length === 0" class="text-center py-12 px-6">
            ...
            <div class="mt-6">
              <router-link to="/" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
          ...
          <ul v-else class="divide-y divide-gray-200">
            <transition-group name="message-fade">
              <li
                ...
                :key="message.id"
                :class="{ 'bg-blue-50': !message.read, 'bg-white': message.read }"
                class="flex flex-col sm:flex-row items-start sm:items-center py-4 px-6 hover:bg-gray-50 transition-colors duration-150 cursor-pointer"
              >
                <div class="flex items-center flex-grow mb-3 sm:mb-0">
                  <div 
                    :class="{ 'bg-blue-500': !message.read, 'bg-gray-400': message.read }" 
                  ...
                  <div class="flex-grow">
                    <p 
                      :class="{ 'font-medium text-gray-900': !message.read, 'text-gray-700': message.read }" 
                ...
                <div class="flex-shrink-0 ml-0 sm:ml-6 flex space-x-2 mt-3 sm:mt-0">
                  <button
                    v-if="!message.read"
                  ...
                  <button
                    ...
                    class="p-2 rounded-full text-gray-500 hover:bg-red-100 hover:text-red-600 transition-colors duration-200"
